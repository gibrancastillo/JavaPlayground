...
public class ArrayStructureModel {
	 ...
	 * 
	 * Assumptions are that the array is sorted, rotated counter clockwise and has no duplicates
	 * 
	 * Number of rotations = the index of the minimum element
	 * See Example below:
	 * Array Elements:   2, 3, 5, 8, 11, 12    No counter clockwise rotation
	 * Array Indexes:    0  1  2  3   4   5
	 * 
	 * Array Elements:   12, 2, 3, 5, 8, 11    Rotated once counter clockwise
	 * Array Indexes:    0   1  2  3  4   5
	 * 
	 * Array Elements:   11, 12, 2, 3, 5, 8    Rotated twice counter clockwise
	 * Array Indexes:    0    1  2  3  4  5
	 * 
	 * In this case the index of the minimum element is two, which is the number of rotations. 
	 * 
	 * 
	 * @param theArr
	 * @param arrayLength
