...
public class LinkList{
	// Reference to first Link in the singly linked list
	// Which is the last Link added to the LinkedList
	...
	public Link removeFirst(){
		...
		if(!isEmpty()){
			...
			System.out.println("Empty singly LinkedList");
		}
