package com.ccc.playground.closedhash;
 ...
 *  
 *  
 *  This class implements a Hash Table [array] that uses a Closed Hashing or Open Addressing
 *  collision resolution policy with a Linear Probing collision resolution strategy.
 * 
...
public class LinearProbingHashFunction {
	...
	public static void main(String[] args) {
		...
		LinearProbingHashFunction theFunc = new LinearProbingHashFunction(30);
